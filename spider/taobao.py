...
o-item.1&ie=utf8&initiative_id=tbindexz_20170306&p4ppushleft=1%2C48&s={44*i}'for i in range(0,3) ]
cookie_dic = {}
...
def make_dic():
    ...
    dic_cookie = {}
    for each in cookies_raw.split()[1:]:
...
def save():
    with open('./../midea/taobao.txt','w',encoding='utf-8')as f:
